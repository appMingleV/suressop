    ...
    try {
        ...
        if(arrQuery.indexOf(query)==-1){
            return res.status(400).json({
             ...
             const qeuryVendorList=`SELECT ownerName,gender,dob,mobile,email,address,status FROM Vendor`;
        ...
        const queryVendorList = `SELECT ownerName,gender,dob,mobile,email,address,status FROM Vendor WHERE status=?`;
